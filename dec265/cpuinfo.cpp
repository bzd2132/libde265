	...
	*((int*)(CPUString + 8)) = CPUInfo[2];
	...
	for (i = 0; i <= nIds; ++i)
	{
		...
		if (i == 1)
		{
			...
			info->core_number = nLogicalProcessors = ((CPUInfo[1] >> 16) & 0xff);
			...
			info->support_sse3 = bSupplementalSSE3 = (CPUInfo[2] & 0x200) || false;
			...
			info->support_sse4_1 = bSSE41Extensions = (CPUInfo[2] & 0x80000) || false;
			info->support_sse4_2 = bSSE42Extensions = (CPUInfo[2] & 0x100000) || false;
